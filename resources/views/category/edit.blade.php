...
@section('content')
                        ...
                        <form method="POST" action="{{route('category.update',$category->id)}}">
                            ...
                            <div class="form-group">
                                <select name="parent_id" class="form-control">
                                    <option value="0">--Thuộc vào danh mục--</option>
    ...
    <?php
    function showCategories($categories,$current_data ,$parent_id = 0, $char = '')
    {
        foreach ($categories as $key => $item)
        {
            ...
            if ($item->parent_id == $parent_id)
            {
                if ($current_data->id==$item->id){
                    echo '<option value="'.$item->id.'" disabled>'.$char.$item->title.'</option>';
                ...
                showCategories($categories,$current_data, $item->id, $char.'---');
            }
        }
    }
    ?>
